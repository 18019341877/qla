        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button
              ...
              size="mini"
              icon="el-icon-edit"
              @click="onOptionClick('edit',scope.row)"></el-button>
          </template>
        </el-table-column>
      </el-table>
    </template>
...
import { IApiNaireItem, Citem } from '@/api/types'
...
export default class NavBar extends Vue {
  ...
  public async fetchListData () {
    ...
    this.list = (res.data as any).data ? (res.data as any).data : []
  }
}
</script>
